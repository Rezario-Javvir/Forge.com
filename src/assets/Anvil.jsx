...
function Anvil() {
  return (
    <svg width="50px" height="50px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#eeff00" stroke="#eeff00" stroke-width="0.00512">
